...
urlpatterns = [
	...
	path('change-group-owner-search', ChangeOwnerSearch.as_view(), name='change-group-owner-search'),
	path('add-admin-search', AddAdminSearch.as_view(), name='add-admin-search'),
